...
def generate_signal_summary(thread, signal, deliverable_type, users, mgr_ids):
    ...
    prompt = (
        ...
        f'Issues: [The single most specific root cause of WHY the signal happened. '
        f'2-3 words. Only label what is clearly evidenced in the thread. '
        f'If the signal is fully explained by itself (e.g. manager simply missed a message), write "None". '
        f'Do NOT stack multiple labels — pick the ONE that best explains the signal. '
        ...
        f'- "Design Oversight": a visible detail already present in the design was missed by the designer before submission (not a missing scenario — something observable that was overlooked).\n'
        ...
        f'Issues: None\n\n'
        f'Good example (Missing Pattern):\n'
        f'Summary: No existing component matched the required layout pattern.\n'
